...
import com.brainict.smartwave.databinding.FragmentRestBinding;
...
public class RestFragment extends DefaultFragment implements View.OnClickListener {
    private FragmentRestBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_rest, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (int i = 1; i < 12; i++) {
            int imgRes = getResources().getIdentifier("rest" + i, "drawable", getActivity().getPackageName());
            if (imgRes == 0) {
                break;
            }
    ...
    public void startMusicService() {
        ...
        mMusicIntent.setAction(Constants.REST_ACTION);
